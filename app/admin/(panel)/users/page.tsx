                ...
                <div key={u.id} className="hover:bg-slate-50 transition-colors">
                  ...
                  <div className="sm:hidden px-4 py-3 space-y-2">
                    ...
                    <div className="flex items-center justify-between gap-2 flex-wrap">
                      <span className="text-xs font-semibold text-slate-600">{u.level}</span>
                      {pointsField}
                  ...
                  <div className="hidden sm:grid px-5 py-3 grid-cols-12 gap-3 items-center">
                    ...
                    {/* Points */}
                    <div className="col-span-2 text-right">{pointsField}</div>

                    {/* Actions */}
                    <div className="col-span-2 flex items-center justify-end gap-1.5">{actions}</div>
                  </div>
                </div>
              );
            })}
