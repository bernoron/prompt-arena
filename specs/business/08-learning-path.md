...
Viele Nutzer wissen nicht, wie sie KI-Werkzeuge effektiv einsetzen können — und schreiben deshalb suboptimale Prompts. Der strukturierte Lernpfad bietet geführtes Wissen in kompakten Lektionen: von den Grundlagen der KI bis zu fortgeschrittenen Prompting-Techniken. Nutzer, die den Lernpfad durchlaufen, schreiben bessere Prompts, teilen mehr und nutzen die Plattform intensiver. Gleichzeitig werden abgeschlossene Lektionen mit Punkten belohnt, was den Lernpfad nahtlos ins Gamification-System integriert.
...
|-------|-------------|-------------|
| Nutzer (Einsteiger) | Kennt KI-Tools kaum oder hat unsystematisches Vorwissen | Erhält strukturiertes Grundlagenwissen und traut sich, Prompts einzureichen |
| Nutzer (Fortgeschrittene) | Kennt KI-Grundlagen, will systematischer werden | Vertieft Techniken und sammelt dabei Punkte |
| Admin | Beobachtet Nutzungsverhalten | Kann Fortschritt der Nutzerbasis nachverfolgen |

---

## User Stories

- Als **Nutzer** will ich eine übersichtliche Kursstruktur mit Modulen und Lektionen sehen, damit ich weiss, was ich noch lernen kann und wie weit ich bin.
- Als **Nutzer** will ich innerhalb einer Lektion Erklärungen, Praxis-Tipps, Gut-/Schlecht-Beispiele und wiederverwendbare Muster sehen, damit ich das Gelernte direkt anwenden kann.
- Als **Nutzer** will ich eine Lektion als abgeschlossen markieren und dafür 15 Punkte erhalten, damit sich der Lernaufwand doppelt lohnt.
- Als **Nutzer** will ich meinen Lernfortschritt visuell verfolgen können, damit ich weiss, wie viel ich schon gelernt habe.
- Als **Nutzer** will ich direkt von meinem Dashboard zur nächsten offenen Lektion navigieren können, damit mir der Einstieg ins Lernen leicht gemacht wird.

---

## Business-Akzeptanzkriterien

- [ ] **BAC-08-001**: Die Lernübersicht zeigt alle 5 Module mit ihren Lektionen und dem persönlichen Fortschritt des Nutzers.
...
- [ ] **BAC-08-003**: Ein Nutzer kann eine Lektion als abgeschlossen markieren und erhält dafür einmalig 15 Punkte.
...
| R2 | Nutzer schliessen Lektionen mechanisch ab (ohne Lesen), nur für Punkte | mittel | Akzeptiert — der Lerninhalt ist trotzdem verfügbar; keine erzwungene Lesezeit |
| A1 | Nutzer lesen Lerninhalt auf Deutsch | hoch | Inhalt ist vollständig auf Deutsch; kein Mehrsprachigkeitsbedarf für Lerninhalt |
