...
|-------|-------------|-------------|
| Nutzer | Möchte Bonus-Punkte sammeln und an einem wöchentlichen Thema mitwirken | Erhält 30 Punkte für eine Einreichung; Gewinner erhält 100 Punkte |
...
- Als **Nutzer** will ich sehen, ob gerade eine aktive Challenge läuft, damit ich entscheide, ob ich daran teilnehmen möchte.
- Als **Nutzer** will ich beim Einreichen eines Prompts wählen können, ob er für die aktuelle Challenge zählt, damit ich gezielt teilnehme und Bonus-Punkte erhalte.
...
- [ ] **BAC-06-001**: Nutzer sehen auf der Einreichungsseite eine Hinweiskarte zur aktuell aktiven Challenge.
...
- [ ] **BAC-06-002**: Ein Nutzer kann beim Einreichen eines Prompts wählen, ob er diesen für die aktive Challenge einreicht, und erhält dafür 30 Punkte.
  - **Messgrösse**: Nach einer Challenge-Einreichung steigt der Punktestand des Nutzers um 30; der Prompt erscheint in der Bibliothek und ist der Challenge zugeordnet.
  - **Geschäftsregel**: Die 30 Punkte werden zusätzlich zu den normalen 20 Einreichungs-Punkten vergeben (sofern das Gamification-System beides vergibt). Ein Nutzer kann mehrere Prompts für dieselbe Challenge einreichen.
...
- [ ] **BAC-06-004**: Der Admin kann eine Challenge aktivieren oder beenden; bei Aktivierung werden alle anderen Challenges automatisch deaktiviert.
  ...
  - **Geschäftsregel**: Kein Nutzer kann eine Challenge selbst aktivieren oder beenden — das ist ausschliesslich dem Admin vorbehalten.
...
- Öffentliche Challenge-Übersicht für Nutzer (ausser dem Hinweis auf der Einreichungsseite)
...
| R2 | Nutzer reichen viele Prompts ein, nur um die 30 Punkte zu erhalten, ohne Qualität zu beachten | niedrig | Bewertungssystem reguliert Sichtbarkeit; Admin kann löschen |
